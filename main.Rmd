...
> 待完善：数据集的背景什么的可以到英文网站上翻译 ^[数据来源: https://www.kaggle.com/c/GiveMeSomeCredit/overview]
...
```{r}
ggplot(dat, aes(x = age, fill = SeriousDlqin2yrs)) +
...
Friedman等（2000）发现分类问题可以当作是正向分布可加模型，通过最小化指数损失函数实现分类。

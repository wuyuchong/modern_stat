...
\textsc{\Large 现代统计软件课程}\\[0.5cm] % Minor heading such as course title
...
\HRule \\[0.4cm]
{ \huge \bfseries 信用卡逾期预测判别——基于多种模型}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
...
\textsc{\large 高思琴}\\[0.5cm] % Minor heading such as course title
\textsc{\large 陈蔚}\\[0.5cm] % Minor heading such as course title
\textsc{\large 指导老师：杨玥含}\\[0.5cm] % Minor heading such as course title
\end{center}
